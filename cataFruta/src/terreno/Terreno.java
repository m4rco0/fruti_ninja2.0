...
public class Terreno {
	...
	/**
	 * Coloca um número especificado de pedras em posições aleatórias no terreno. As
	 * pedras são posicionadas em locais aleatórios no mapa, garantido que a posição
	 ...
	 * @param arvGoiaba
	 */
	public void adicionarArvores(int arvMaracuja, int arvLaranja, int arvAbacate, int arvCoco, int arvAcerola,
			int arvAmora, int arvGoiaba) {
